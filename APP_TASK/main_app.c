               ...
               if(ether_st.RX_flag==1)
							 {
								 ...
								 //有线报警器的信息
								     if(ether_st.RX_pData[2]==device_type)
									   {
										     switch(ether_st.RX_pData[3])
												 {												
													  case 0x01 :  
                                         Line_1A_WT588S(6);//			获取地址成功     
				                      HAL_Delay(500);  //延迟播放音乐
																
														   dev_buffer[0]=ether_st.RX_pData[4]; 
													     dev_buffer[1]=ether_st.RX_pData[5];
		...
		if(get_key1()==0)
{
	   ...
	   switch(rang_state)
	 {
		 ...
		 case 1 :    
			                      eth_ring.dev_pData[0]=0x01;   
                            eth_ring.dev_pData_len=1;	 
			               		 eth_ring_com_pack(eth_ring.RX_pData,dev_buffer,alarm_report_function,eth_ring.dev_pData,eth_ring.dev_pData_len,product_key);
	               send_string_to_eth(eth_ring.RX_pData,eth_ring_com_pack(eth_ring.RX_pData,dev_buffer,alarm_report_function,eth_ring.dev_pData,eth_ring.dev_pData_len,product_key)); ;
	   ...
	   if(ring_flag==1)
		 {
			       eth_ring.dev_pData[0]=0x01;   
                            eth_ring.dev_pData_len=1;	 
			               		 eth_ring_com_pack(eth_ring.RX_pData,dev_buffer,Manual_away_p_function,eth_ring.dev_pData,eth_ring.dev_pData_len,product_key);
	 send_string_to_eth(eth_ring.RX_pData,eth_ring_com_pack(eth_ring.RX_pData,dev_buffer,Manual_away_p_function,eth_ring.dev_pData,eth_ring.dev_pData_len,product_key)); ;
			 rang_state=0;
			  printf("xiaojingchengg\r\n");
			   ring_flag=0;
  ...
  if( runing_flag==2)
	{
		                       eth_ring.dev_pData[0]=0x01;   
                            eth_ring.dev_pData_len=1;	 
			               		 eth_ring_com_pack(eth_ring.RX_pData,dev_buffer,Equipment_run_state_function,eth_ring.dev_pData,eth_ring.dev_pData_len,product_key);
	 send_string_to_eth(eth_ring.RX_pData,eth_ring_com_pack(eth_ring.RX_pData,dev_buffer,Equipment_run_state_function,eth_ring.dev_pData,eth_ring.dev_pData_len,product_key)); ;
